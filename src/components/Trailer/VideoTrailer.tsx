...
export default function VideoTrailer() {
  ...
  //   <iframe width="560" height="315" src="https://www.youtube.com/embed/2bIe00GYIkI?si=fhCt04nlY8TDl23P" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
  ...
  return (
    <section className="py-20 bg-[#191825] relative">
      ...
      {/* <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#191825] pointer-events-none"></div> */}
    </section>
  );
}
